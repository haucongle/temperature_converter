...
export function convertTemperature(inputValue, fromUnit, toUnit) {
	...
	return `${value} ${fromUnit} = ${convertedValue.toFixed(2)} ${toUnit}`
}
...
function App() {
	...
	const handleConvertTemperature = () => {
		const conversionResult = convertTemperature(inputValue, fromUnit, toUnit)
	...
	return (
		<div className='App'>
			...
			{result && <p style={{ marginTop: '1rem', fontSize: '1.2rem', color: '#333' }}>{result}</p>}
		</div>
	)
}
